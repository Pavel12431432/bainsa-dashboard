    ...
    <div className="flex flex-col gap-6 h-[calc(100vh-100px)]">
      ...
      <div className="flex gap-0 flex-1 min-h-0 max-lg:flex-col max-lg:gap-6">
        ...
        <div className="flex-1 min-w-0 flex flex-col min-h-0">
          ...
          {/* Version history */}
          {history.length > 0 && (
            <div className="mt-3 shrink-0 flex flex-col border border-border-mid rounded-lg">
              {/* Viewing banner */}
              {viewingIdx !== null && (
                <div className="flex items-center justify-between gap-3 px-3.5 py-2 bg-border-light">
                  <p className="text-[0.7rem] text-brand-white opacity-70 m-0">
                    Viewing: {history[viewingIdx].label}
                  </p>
              ...
              <div className="max-h-32 overflow-y-auto">
                {[...history].reverse().map((entry, ri) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`w-1.5 h-1.5 rounded-full shrink-0 ${isActive ? "bg-brand-white" : "bg-border-mid"}`} />
